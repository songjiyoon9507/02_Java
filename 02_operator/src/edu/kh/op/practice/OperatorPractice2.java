...
public class OperatorPractice2 { // 기능 정의용 클래스
	public void practice4() {
		/* 키보드로 나이를 입력받아
		 * 20세 이상이면 "저는 성인입니다", 아니면 "저는 미성년입니다" 출력
		 * 입력받은 값이 13세 이상이면서 19세 이하면 "청소년입니까? true"출력, 아니면 false
		 * 입력받은 값이 65세 이상이거나, 12세 이하면
		 * "노인이거나 어린이입니까? true" 출력 아니면 false 출력
		 * 
		 * 당신의 나이는? : 20
		 * 저는 성인입니다
		 * 청소년입니까? false
