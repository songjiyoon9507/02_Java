...
//		System.out.println(); 자동완성 syso ctrl+space
		...
		System.out.println("테스트2"); // 다음 줄로 커서 내려 주는 게 일
...
//		System.out.print("\n"); // 위와 같은 내용
		...
		// System.out.printf("%형식", 변수 등) : 출력될 문자열 형식을 패턴으로 지정하는 출력구문
		
		System.out.println(); // 위에 print 구문 써서 옆에 붙어나오니까 줄바꿈 써줌
		...
		// System.out.printf("패턴", 패턴의 들어갈 값); 패턴은 문자열로 표현
		// 줄바꿈 안됨
		// 10 + 5 = 15
		...
		// 소수점 자리 제어 (반올림처리)
		System.out.printf("%f\n",10 / 4.0); // 2.500000
		System.out.printf("%.2f\n",10 / 4.0); // 소수점 둘째짜리까지만 나타내고 싶을 때
		System.out.printf("%.0f\n",10 / 4.0); // 소수점 아래를 표현하지 않겠다
		
		// 문자, 문자열, boolean
		boolean isTrue = false;
		char ch = '조'; // 홑따옴표
		String str = "안녕하세요"; // String은 참조형 쌍따옴표 사용
		...
		// \t tab 출력
		System.out.println("a\tb\tc\td"); // 한공간씩 표현X, 한번에 공간 차지
